...
public class CamelliaCrypto {
    ...
    private static SecretKey generateKey() throws Exception {
        // Генерация ключа с помощью Bouncy Castle
        return new SecretKeySpec(org.bouncycastle.util.encoders.Hex.decode("000102030405060708090A0B0C0D0E0F"), ALGORITHM);
    }
